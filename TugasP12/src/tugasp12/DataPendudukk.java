...
public class DataPendudukk extends javax.swing.JFrame {
    ...
    public void connect() {
        try {
            emf = Persistence.createEntityManagerFactory("TugasP12PU");
    ...
    public DataPendudukk() {
        ...
        jTable3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                idAlamatLama = jTable3.getValueAt(row, 0).toString();
                kelurahanLama = jTable3.getValueAt(row, 1).toString();
                kecamatanLama = jTable3.getValueAt(row, 2).toString();
                kabupatenLama = jTable3.getValueAt(row, 3).toString();
                provinsiLama = jTable3.getValueAt(row, 4).toString();
            }
        });
    }
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (data.length == 5) {
                        ...
                        if (alamat != null) {
                            ...
                            String errorMessage = "Alamat dengan kunci '" + alamatKey + "' tidak ditemukan. Record Penduduk ini diabaikan.";
                            JOptionPane.showMessageDialog(this,
                                    errorMessage,
    ...
    private void initComponents() {
        ...
        jPanel21Layout.setVerticalGroup(
            ...
            .addGroup(jPanel21Layout.createSequentialGroup()
                .addComponent(jLabel10, javax.swing.GroupLayout.PREFERRED_SIZE, 48, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            String path = "src/tugasp12/ReportPendudukk.jasper";
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        try {
            String path = "src/tugasp12/ReportAlamat.jasper";
            HashMap<String, Object> parameters = new HashMap<>();
